...
const Store2 = () => {
  return (
   ...
   <div class="store1-right">
    ...
    <div class="info-group">
      ...
      <div class="info-block">
        <h3>Contact</h3>
        <p>Mobile: <strong>068 26589 996</strong></p>
        <p>Hotline: <strong>1900 26886</strong></p>
  ...
  <div class="store2-right">
    <img src="https://glowing.g5plus.net/elementor/wp-content/uploads/2021/10/store-02.jpg" alt="Store Image" />
  </div>
</section>
